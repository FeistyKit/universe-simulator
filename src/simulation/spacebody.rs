...
#[derive(Debug, Serialize, Deserialize, Clone)] //idk why but for some reason this is killing rust analyzer. I'm removing it for now for that sweet, sweet "no errors" message.
